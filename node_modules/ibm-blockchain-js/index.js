...
ibc.prototype.load_chaincode = function(options, cb) {
	...
	if(!options.deployed_name || options.deployed_name === ''){
		logger.log('[ibc-js] options.deployed_name: '  + options.deployed_name); //lets clear and re-download
		//lets clear and re-download
	...
	function cb_ready(){
		...
		logger.log('[ibc-js] unzip_cc_dest: '  + unzip_cc_dest);
